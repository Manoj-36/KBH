    ...
    <div className="Share">
      ...
      {/* <div class="row">
        <div className="column">
          <img src={H1} alt="principal in mess" />
        </div>
        <div className="column">
          <img src={H7} alt="Mess Store room" />
        </div>
        <div className="column">
          <img src={H3} alt="Store Room" />
        </div>
        <div className="column">
          <img src={H4} alt="Mess hall" />
        </div>
        <div className="column">
          <img src={H5} alt="Mess hall" />
        </div>
        <div className="column">
          <img src={H6} alt="Students in Mess" />
        </div>
        <div className="column">
          <img src={H2} alt="Students in Mess" />
        </div>
      </div> */}
